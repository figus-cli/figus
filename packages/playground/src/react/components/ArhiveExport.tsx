...
export function ArhiveExport(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            fill="currentColor"
            viewBox="0 0 24 24"
        ...
        >
            ...
            <path
                fill="currentColor"
                stroke="currentColor"
                d="M21 19V5c0-1.1046-.8954-2-2-2H5c-1.1046 0-2 .8954-2 2v14c0 1.1046.8954 2 2 2h14c1.1046 0 2-.8954 2-2ZM8.5 9.5 12 7m0 0 3.5 2.5M12 7v6"
            />
        </svg>
    );
}
