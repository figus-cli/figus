...
export function ChatPlusDuotoneLine(props: SVGProps<SVGSVGElement>) {
    return (
        ...
        >
            ...
            />
            <path fill="currentColor" stroke="currentColor" d="M9 11h6" />
            <path fill="currentColor" stroke="currentColor" d="M5 8V2M2 5h6" />
            <path fill="currentColor" stroke="currentColor" d="M12 15h3" />
        </svg>
    );
}
