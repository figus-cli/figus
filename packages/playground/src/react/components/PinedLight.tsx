...
export function PinedLight(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            fill="currentColor"
            viewBox="0 0 24 24"
        ...
        >
            ...
            />
            <path fill="currentColor" stroke="currentColor" d="M12 20v-4" />
            <path fill="currentColor" stroke="currentColor" d="M6 20h12" />
        </svg>
    );
}
