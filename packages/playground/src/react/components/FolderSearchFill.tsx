...
export function FolderSearchFill(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            fill="currentColor"
            viewBox="0 0 24 24"
        ...
        >
            ...
            />
            <circle cx="11.5" cy="13.5" r="2.5" stroke="currentColor" />
            <path stroke="currentColor" d="M14.5 16.5 16 18" />
        </svg>
    );
}
